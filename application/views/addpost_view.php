										...
										<div class="col-md-12">
											<div class="panel panel-default">
												...
												<div class="panel-body">
													...
													<?php echo form_open('post/prosesPost',['role'=>'form']);?>
														<div class="form-group">
															<!-- <label for="exampleInputEmail1">Kode Barang</label> -->
															<input type="text" name="title" class="form-control" id="" placeholder="Title Pos">
														</div>
														<div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="case" name="imgCover" class="form-control" id="" placeholder="" style="display:none">
                                                        </div>
														<!-- <div class="form-group">
														...
														<div class="form-group">
                                                            ...
                                                            <textarea name="isiContent" class="ckeditor" id="isiContent"></textarea>
